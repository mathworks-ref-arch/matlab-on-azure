...
// Use this Packer configuration file to build a VHD with R2021b MATLAB installed.
...
BUILD_SCRIPTS               = ["install-startup-scripts.sh", "install-swap-desktop-solution.sh", "install-dependencies.sh", "install-matlab-dependencies-ubuntu.sh", "install-ubuntu-desktop.sh", "setup-mate.sh", "install-matlab.sh", "install-glibc-ubuntu2004.sh", "setup-startup-accelerator.sh",  "install-fabric-manager-ubuntu.sh"]
