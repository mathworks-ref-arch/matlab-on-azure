...
- [Deploy MATLAB on Azure using Online Licensing](/doc/online-licensing-instructions.md)
- [Deploy MATLAB on Azure using Network Licensing](/doc/license-manager-instructions.md)
